...
const SideBar = () => {
    ...
    const{dia, mes, año, hoy, dataCalendario} = useCalendar()
    ...
    return (
        <div className="w-[25%] h-[95%] h border-red border-2 border-solid">
            <section className="h-[10%] flex justify-between items-center border-b-2 border-solid border[--grey]">
                ...
                <button onClick={(e: React.MouseEvent<HTMLButtonElement>) => {handleSidebar(e); setTab(1)}} className="sidebar-btn w-full h-full flex flex-col justify-center items-center text-[--grey] border-r border-l border-dashed border-[--grey] sidebar-selected-btn">Hoy</button>
